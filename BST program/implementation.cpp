...
int subject::retrieve(subject & found)
{
...
// compare the course name of each object for the insertion
int subject::compare(subject & to_compare)
{
	return strcmp(course_num, to_compare.course_num);
}

// compare the object's course name to a temp char to see if there 											  // is a match
int subject::compare_range(char temp_range[])
{
	return strcmp(course_num, temp_range);
}
